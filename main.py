...
class PassCheck(customtkinter.CTkFrame):
    def __init__(self, parent=None):
        ...
        self.passstr.trace(
            "w", lambda name, index, mode, x=self.passstr: self._update(x)
        )
        self.crackstr.trace(
            "w", lambda name, index, mode, x=self.crackstr: self._update(x)
        )
        self.makeWidgets()
    ...
    def makeWidgets(self):
        ...
        self.l = customtkinter.CTkLabel(
            self,
            textvariable=self.strenstr,
            text_color="#363636",
        ...
        self.random = customtkinter.CTkButton(
            self.g,
            text=None,
            image=self.loadd_image,
            fg_color="#181A1B",
            width=35,
            height=35,
        ...
        self.passEntry = customtkinter.CTkEntry(
            self.g,
            textvariable=self.passstr,
            placeholder_text="Try a Password",
            justify="center",
            text_color="#DDE6E8",
            width=200,
        ...
        self.show = customtkinter.CTkButton(
            self.g,
            text=None,
            image=self.showeye_image,
            fg_color="#181A1B",
            width=35,
            height=35,
            command=self.ShowPass,
        )
        ...
        self.t = customtkinter.CTkLabel(
            self,
            textvariable=self.crackstr,
            text_color="#363636",
        ...
        self.lowerc = customtkinter.CTkButton(
            self.f,
            text=None,
            image=self.lower_image,
            fg_color="#181A1B",
            state="disabled",
            width=30,
            height=30,
        )
        self.upperc = customtkinter.CTkButton(
            self.f,
            text=None,
            image=self.upper_image,
            fg_color="#181A1B",
            state="disabled",
            width=30,
            height=30,
        )
        self.numberc = customtkinter.CTkButton(
            self.f,
            text=None,
            image=self.number_image,
            fg_color="#181A1B",
            state="disabled",
            width=30,
            height=30,
        )
        self.specialc = customtkinter.CTkButton(
            self.f,
            text=None,
            image=self.special_image,
            fg_color="#181A1B",
            state="disabled",
            width=30,
            height=30,
...
if __name__ == "__main__":
    ...
    root.update()
    GlobalBlur(
        ctypes.windll.user32.GetForegroundWindow(), hexColor="#1f1f1f00", Acrylic=True
    )
    PassCheck(root).pack()
    root.mainloop()
